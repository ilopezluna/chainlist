...
contract('ChainList', function(accounts) {
    ...
    var articleWeiPrice = web3.toWei(10, "ether");
    ...
    it("should sell an article", function() {
        return ChainList.deployed().then(function(instance) {
            ...
            return chainListInstance
                .sellArticle(articleName, articleDescription, articleWeiPrice, {from : seller});
        }).then(function () {
            ...
            assert.equal(data[3].toNumber(), articleWeiPrice, "article price must be " + articleWeiPrice);
        });
    });
});